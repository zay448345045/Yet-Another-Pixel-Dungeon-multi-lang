...
public class WndStory extends Window {
    ...
    static {
        CHAPTERS.put(ID_SEWERS, Ml.g("visuals.windows.wndstory.chapters_sewers"));

        CHAPTERS.put(ID_PRISON, Ml.g("visuals.windows.wndstory.chapters_prison"));

        CHAPTERS.put(ID_CAVES, Ml.g("visuals.windows.wndstory.chapters_caves"));

        CHAPTERS.put(ID_METROPOLIS, Ml.g("visuals.windows.wndstory.chapters_metropolis"));

        CHAPTERS.put(ID_HALLS, Ml.g("visuals.windows.wndstory.chapters_halls"));
    }
